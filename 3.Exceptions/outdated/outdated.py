...
def check_date(userdate, months):
    ...
    pattern = r'^([1-9]|1[0-2])/([1-9]|[12][0-9]|3[01])/(\d{4})$' # S'assurer que les mois et les jours sont formatés avec deux chiffres, en ajoutant des zéros non significatifs si nécessaire (par exemple, "9" devient "09").
